...
# Este comando serviría para generar el comando que añade nuevos nodos al cluster más adelante.
# kubeadm token create --print-join-command
# sudo kubeadm certs check-expiration             # Ver cuando caducan los certs de comunicacion interna del cluster
#                                                   Por defecto caducan al año.
# sudo kubeadm certs renew all                    # Renovarlos
